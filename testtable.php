                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-center">
                            ...
                            <tbody id="testTableBody">
                                <?php
                                $sql = "SELECT *, (@test_id := @test_id + 1) AS TestID
                                        FROM test, (SELECT @test_id := 0) AS counter";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edittest.php?id=<?php echo $row["TestID"] ?>"
                                            class="link-dark"><i
                                                class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                        <a href="deletetest.php?id=<?php echo $row["TestID"]; ?>" class="link-dark">
