                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-center">
                            ...
                            <tbody id="treatmentTableBody">
                                <?php
                                $sql = "SELECT *, (@treatment_id := @treatment_id + 1) AS TreatmentID
                                        FROM treatmentplan, (SELECT @treatment_id := 0) AS counter";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["TreatmentDescription"] ?></td>
                                    <td><?php echo $row["TreatmentNotes"] ?></td>
                                    <td>
                                        <a href="edittreatment.php?id=<?php echo $row["TreatmentID"] ?>"
                                            class="link-dark"><i
                                                class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                        <a href="deletetreatment.php?id=<?php echo $row["TreatmentID"]; ?>" class="link-dark">
